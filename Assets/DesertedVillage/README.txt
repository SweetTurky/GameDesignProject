Thank you for purchasing Deserted Village Kit. I hope you like it and it fits your needs.

Please use the following project settings when using The Deserted Village Kit
...
To achieve the same visuals as shown in the screenshots install the Post Processing stack via the the Windows->Packet Manager. 
