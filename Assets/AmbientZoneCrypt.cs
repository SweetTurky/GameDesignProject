...
{
    public class AmbientZoneCrypt : MonoBehaviour
    {
        ...
        public float minHeight = 0f; // Minimum height of the zone
        public float maxHeight = 10f; // Maximum height of the zone
        ...
        void Update()
        {
            ...
            bool insideZone = Vector3.Dot(Sub, Spline) > 0 && Player.transform.position.y >= minHeight && Player.transform.position.y <= maxHeight;
